...
import functions, json, os, yaml, interface
...
#each corresponds to a <td> table data with the respective content
publTemplate = """
...
def createIndex(pathToMemex):    
    ...
    for k,v in bibData.items():         
        ...
        entry = "<tr><td><li><a href="+"@PATHTOPUBL@/pages/DETAILS.html>"+"[@CITEKEY@]</a></td><td> @AUTHOR@</td> <td>(@DATE@)</td> - <td><i>@TITLE@</i></td></li></tr>" #here I added the <td>        
